...
{
  if      (id == CRSSEC_XY) m_plane_xy = (float)min(1.0, max(0.0, m_plane_xy + delta / 120.0 / reso[0]));
  else if (id == CRSSEC_YZ) m_plane_yz = (float)min(1.0, max(0.0, m_plane_yz + delta / 120.0 / reso[1]));
  else if (id == CRSSEC_ZX) m_plane_zx = (float)min(1.0, max(0.0, m_plane_zx + delta / 120.0 / reso[2]));
