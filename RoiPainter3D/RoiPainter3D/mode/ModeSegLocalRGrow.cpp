...
void ModeSegLocalRGrow::runLocalRegionGrow()
{
  ...
  //seedñàÇ…Ç–Ç∆Ç¬Ç√Ç¬Region growingÇåvéZ
	...
	{
		//flgèâä˙âª(0:locked, 1:yet fixed, 2:negative, 255:positive)
    //ëOåiÇÃéû : locked(0)Ç∆negaticve(2)à»äOÇyet(1)Ç…
    //îwåiÇÃéû : óÃàÊÇÃåvéZÇÕëSëÃÇ…ëŒÇµÇƒçsÇ§
...
)
{
    ...
    //unisotropic volumeÇ≈ÅAseedÇ™ã»ê¸èÛÇ»ÇÃÇ≈Ç±ÇÃé¿ëïÇÃÇŸÇ§Ç™ëΩè≠ê≥äm
